			  	...
			  	<form action="{{ route('kategori.update',$kategori->id) }}" method="post" >
        			...
        			{{ csrf_field() }}
			  		<div class="form-group {{ $errors->has('news') ? ' has-error' : '' }}">
			  			...
			  			<input type="text" name="news" value="{{ $kategori->news }}" class="form-control"  required>
			  			@if ($errors->has('news'))
                     ...
                     <div class="form-group {{ $errors->has('infotainment') ? ' has-error' : '' }}">
			  			...
			  			<input type="text" name="infotainment" value="{{ $kategori->infotainment }}" class="form-control"  required>
                      ...
                      <div class="form-group {{ $errors->has('sport') ? ' has-error' : '' }}">
			  			...
			  			<input type="text" name="sport" value="{{ $kategori->sport }}" class="form-control"  required>
			  			@if ($errors->has('sport'))
                            <span class="help-block">
                      ...
                      <div class="form-group {{ $errors->has('politik') ? ' has-error' : '' }}">
			  			...
			  			<input type="text" name="politik" value="{{ $kategori->politik }}" class="form-control"  required>
                      ...
                      <div class="form-group {{ $errors->has('fashion') ? ' has-error' : '' }}">
			  			...
			  			<input type="text" name="fashion" value="{{ $kategori->fashion }}" class="form-control"  required>
			  		...
			  		<div class="form-group {{ $errors->has('artikel_id') ? ' has-error' : '' }}">
			  			...
			  			<select name="artikel_id" class="form-control">
			  				@foreach($art as $data)
			  				<option value="{{ $data->id }}" {{ $selectedArt == $data->id ? 'selected="selected"' : '' }} >{{ $data->judul }}</option>
			  				@endforeach
			  			</select>
